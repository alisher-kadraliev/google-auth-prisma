...
const Create = () => {
    ...
    const onSubmit = async (values: z.infer<typeof CreateTagsSchema>) => {
        setIsLoading(true)
        toast.promise(
            createTags(values),
            {
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <Input disabled={isLoading}  {...field} placeholder='Write your title' type='text' />
                                                    </FormControl>
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <Input disabled={isLoading}  {...field} placeholder='slug' type='text' value={field.value || ''} />
                                                    </FormControl>
                                                    <FormMessage className='bg-destructive/15 text-destructive py-1 px-2 rounded-lg dark:text-red-500 dark:bg-none' />
                                                </FormItem>
                                            )}
